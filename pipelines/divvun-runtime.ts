    ...
    if (target.includes("apple")) {
      ...
      buildSteps.push(command({
        ...
        command: [
          ...
          "echo '--- Signing'",
          `divvun-actions run macos-sign ./divvun-runtime-unsigned-${target} '' ./Entitlements.plist`,
    ...
    if (os(target) === "macos") {
      ...
      uiBuildSteps.push(command({
        ...
        command: [
          ...
          "echo '--- Signing'",
          `divvun-actions run macos-sign './Divvun Runtime Playground.app' '' ./Entitlements.plist`,
